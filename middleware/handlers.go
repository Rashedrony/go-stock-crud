...
func GetStock(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Fatalf("Unaable to convert the string to an integer. %v", err)
	}

	stock, err := getStock(int64(id))

	if err != nil {
		log.Fatalf("Unaable to get stock. %v", err)
	}
...
func GetAllStock(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Fatalf("Unaable to get all stock. %v", err)
	}
...
func UpdateStock(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Fatalf("Unaable to decode the request body. %v", err)
	}
...
func updateStock(id int64, stock models.Stock) int64 {
	...
	if err != nil {
		log.Fatalf("Error while checking the afffected rows. %v", err)
	}
